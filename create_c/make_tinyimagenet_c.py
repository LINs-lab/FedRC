...
for i in range(client_number):
    ...
    save_data(client,'./data/tiny-imagenet-c/{}.pkl'.format(i))
...
save_data(client_1,'./data/tiny-imagenet-c/test-1.pkl')
save_data(client_2,'./data/tiny-imagenet-c/test-2.pkl')
save_data(client_3,'./data/tiny-imagenet-c/test-3.pkl')
